          ...
          <div className="flex flex-col items-center justify-between w-full gap-4">
            ...
            <div className="w-full">
              <input
                ...
                type="text"
                id="last_name"
                class=" border border-primary text-gray- text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray- dark:border-gray- dark:placeholder-gray- dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
