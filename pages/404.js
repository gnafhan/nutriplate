export default function NotFound(params) {
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-3xl tracking-tight font-bold text-primary md:text-4xl dark:text-white">Halaman belum tersedia</p>
            <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Silahkan cek berkala </p>
