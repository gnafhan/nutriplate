...
export const CardMakanan = ({name, deskripsi, link}) => {
  return (
<div className="self-stretch max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img className="rounded-t-lg " src="/img/foodPlaceholder.jpg" alt="" />
    </a>
    <div className="p-5">
        <a href="#">
