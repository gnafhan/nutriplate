...
const Navbar = () => {
  ...
  return (
    <div className='w-full'>
      <nav className='container relative flex flex-wrap items-center justify-between max-w-screen-xl p-8 mx-auto lg:justify-between xl:px-0'>
        {/* Logo  */}
        <Disclosure>
          {({ open }) => (
            <>
              <div className='flex flex-wrap items-center justify-between w-full lg:w-auto'>
                ...
                <Disclosure.Button
                  ...
                  className='px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-primary focus:text-primary focus:bg-blue-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700'
                >
                  <svg
